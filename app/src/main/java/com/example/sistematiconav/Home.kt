...
class Home : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.btnModa.setOnClickListener{
            findNavController().navigate(R.id.action_home2_to_moda)
        }

        binding.btnCubo.setOnClickListener{
            findNavController().navigate(R.id.action_home2_to_cubo)
        }

        binding.btnPersona.setOnClickListener{
            findNavController().navigate(R.id.action_home2_to_nombre)
        }
    }
